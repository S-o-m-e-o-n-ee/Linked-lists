 ...
 * Date   : 04/25/2024
 * File   : Q2.c
 * Notes  : Inserts a node to the end of a singly linked list.
*/
...
int main() {
    ...
    printf("\n\n Linked List : Inserts a node to the end of a singly linked list:\n");
    printf("---------------------------------------------------------------------\n");
...
struct Node * insert(struct Node *firstNode, int data) {
    ...
    // Iterates over the linked list to find that last node
